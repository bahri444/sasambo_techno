                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-2 col-sm-5 col-md-4">
                                                    <h6 class=" color__green">Jenis kain</h6>
                                                </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-2 col-sm-5 col-md-4">
                                                    <h6 class=" color__green">Warna</h6>
                                                </div>
                                                <div class="col-lg-4 col-sm-7 col-md-8">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-2 col-sm-5 col-md-4">
                                                    <h6 class=" color__green">Jumlah stok</h6>
                                                </div>
                                                <div class="col-lg-4 col-sm-7 col-md-8">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-2 col-sm-5 col-md-4">
                                                    <h6 class=" color__green">Jumlah order</h6>
                                                </div>
                                                <div class="col-lg-4 col-sm-7 col-md-8">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-2 col-sm-5 col-md-4">
                                                    <h6 class=" color__green">Total produk</h6>
                                                </div>
                                                <div class="col-lg-4 col-sm-7 col-md-8">
